...
/**
 * 
 * Class handles reading from plain and formatted .txt files
 *
 */
...
public class Input {
	...
	public static String ReadFromPlain() throws IOException {
		...
		try (BufferedReader dirFile = new BufferedReader(
				new FileReader("./src/main/resources/com/txt/inOutput_plain.txt"))) {
	...
	public static String ReadFromFormatted() throws IOException {
		...
		try (Scanner scanner = new Scanner(
				new BufferedReader(new FileReader("./src/main/resources/com/txt/inOutput_formatted.txt")))) {
			// String input;

...
/**
 * File Chooser class enables manual picking of the files (directory path) available for the user
 */
...
public final class DPFileChooser extends Application {
	...
	public void start(final Stage stage) {
		...
		Alert alert = new Alert(AlertType.NONE,
				"Program will read file and return file path. Click next to select the file.", ButtonType.NEXT,
				ButtonType.CANCEL);
		alert.showAndWait();
	...
	private void openFile(File file) {
		...
		try {
			...
			Logger.getLogger(DPFileChooser.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

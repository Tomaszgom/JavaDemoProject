 ...
 * Working development class, part of Composition Module
 * 
 * This it more of a training module, to signal being familiar with basic but crucial OOP programming concepts
 * 
 ...
 * In simple Demo example - a Car.
 * Car is super class and is composed of subclasses, one engine and 4 wheels.
 * Car has an engine.
 * Car has wheels.
 * Car class is created from engine and 4 wheels.
 * Whenever we need to check oil level or any other part of the car, we will first call car 
 * in which we have the engine. Engine has method that allows to check the oil level.
*/
